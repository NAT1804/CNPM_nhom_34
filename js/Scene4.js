class Scene4 extends Phaser.Scene {
	...
	create() {
		...
		this.duongray1 = this.add.image(250, config.height*3/4, "duong-ray1");
		this.duongray2 = this.add.image(700, config.height*3/4, "duong-ray2");
		this.duongray2 = this.add.image(1150, config.height*3/4, "duong-ray2");
		//this.bodytrain19 = this.add.image(450, config.height*3/4 -100, "body-train19");
		this.headtrain0 = this.add.image(200, config.height*3/4 - 110, "head-train0");
